...
#        '#flag linux -lVkLayer_assistant_layer',
#        '#flag linux -lVkLayer_device_simulation',
#        '#flag linux -lvkdisplay_wayland',
#        '#flag linux -lVkLayer_vktrace_layer',
#        '#flag linux -lSPIRV-Tools-shared',
#        '#flag linux -lVkLayer_monitor',
#        '#flag linux -lVkLayer_unique_objects',
#        '#flag linux -lVkLayer_screenshot',
#        '#flag linux -lVkLayer_thread_safety',
#        '#flag linux -lVkLayer_api_dump',
...
#        '',
    ...
    genOpts['vlang_core.v'] = [
        ...
        VGeneratorOptions(
            ...
            versions          = featuresPat,
            emitversions      = featuresPat,
            #NOTE Anton: to remove default extensions (also removes SurfaceKHR, wich is required for glfw)
            # defaultExtensions =  None
            defaultExtensions = defaultExtensions,
            addExtensions     = addExtensionsPat,
            removeExtensions  = removeExtensionsPat,
